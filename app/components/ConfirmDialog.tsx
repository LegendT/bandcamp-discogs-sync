                ...
                <div className="mt-2">
                  ...
                  <div className="mt-3 p-3 bg-blue-50 rounded-md">
                    <p className="text-sm text-blue-800">
                      <strong>{itemCount}</strong> items will be added to your Discogs collection.
                    </p>
                    <p className="text-xs text-blue-600 mt-1">
                      This action cannot be undone. You&apos;ll need to manually remove items from Discogs if needed.
                    </p>
                  </div>
                </div>
              </div>
